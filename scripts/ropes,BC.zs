...
recipes.addShaped(<Railcraft:tile.railcraft.machine.beta:6>, [[<Railcraft:part.plate:1>, <terrafirmacraft:item.flintAndSteel>, <Railcraft:part.plate:1>], [<ore:ingotBlackSteel>, <minecraft:iron_bars>, <ore:ingotBlackSteel>], [<Railcraft:part.plate:1>, <Eln:Eln.TransparentNode:192>, <Railcraft:part.plate:1>]]);
recipes.addShaped(<Railcraft:tile.railcraft.machine.alpha:8>, [[<ore:craftingPiston>, <ore:ingotRedSteel>, <ore:craftingPiston>], [<ore:ingotBlueSteel>, <BiblioCraft:BiblioWorkbench:6>, <ore:ingotBlackSteel>], [<ore:craftingPiston>, <ore:ingotSteel>, <ore:craftingPiston>]]);
...
recipes.addShaped(<BuildCraft|Factory:refineryBlock>, [[<minecraft:redstone_torch>, <Railcraft:tile.railcraft.machine.beta:14>, <minecraft:redstone_torch>], [<Railcraft:tile.railcraft.machine.beta:14>, <BuildCraft|Core:diamondGearItem>, <Railcraft:tile.railcraft.machine.beta:14>]]);
recipes.addShaped(<BuildCraft|Factory:pumpBlock>, [[<Railcraft:tile.railcraft.machine.beta:14>], [<BuildCraft|Factory:miningWellBlock>]]);
