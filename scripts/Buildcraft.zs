...
// ================================================================================
//#MARKER ADD SHAPED
recipes.addShaped(<BuildCraft|Builders:architectBlock>, [[<terrafirmacraft:item.dyePowder>, <BuildCraft|Core:markerBlock>, <terrafirmacraft:item.dyePowder>], [<terrafirmacraft:item.Powder:7>, <BiblioCraft:BiblioWorkbench:*>, <terrafirmacraft:item.Powder:7>], [<BuildCraft|Core:diamondGearItem>, <BuildCraft|Builders:blueprintItem>, <BuildCraft|Core:diamondGearItem>]]);
...
recipes.addShaped(<BuildCraft|Builders:builderBlock>, [[<terrafirmacraft:item.dyePowder>, <BuildCraft|Core:markerBlock>, <terrafirmacraft:item.dyePowder>], [<terrafirmacraft:item.Powder:7>, <BiblioCraft:BiblioWorkbench:*>, <terrafirmacraft:item.Powder:7>], [<BuildCraft|Core:diamondGearItem>, <terrafirmacraft:Chest TFC:*>, <BuildCraft|Core:diamondGearItem>]]);
recipes.addShaped(<BuildCraft|Builders:fillerBlock>, [[<terrafirmacraft:item.dyePowder>, <BuildCraft|Core:markerBlock>, <terrafirmacraft:item.dyePowder>], [<terrafirmacraft:item.Powder:7>, <BiblioCraft:BiblioWorkbench:*>, <terrafirmacraft:item.Powder:7>], [<BuildCraft|Core:goldGearItem>, <terrafirmacraft:Chest TFC:*>, <BuildCraft|Core:goldGearItem>]]);
recipes.addShaped(<BuildCraft|Core:markerBlock>, [[<ore:Tubes$anyDye>], [<ore:torchRedstoneActive>]]);
...
recipes.addShaped(<BuildCraft|Factory:autoWorkbenchBlock>, [[null, <BuildCraft|Core:stoneGearItem>, null], [<BuildCraft|Core:stoneGearItem>, <BiblioCraft:BiblioWorkbench:*>, <BuildCraft|Core:stoneGearItem>], [null, <BuildCraft|Core:stoneGearItem>, null]]);
recipes.addShaped(<BuildCraft|Builders:machineBlock>, [[<ore:gearIron>, <minecraft:redstone>, <ore:gearIron>], [<BuildCraft|Core:goldGearItem>, <BuildCraft|Factory:miningWellBlock>, <BuildCraft|Core:goldGearItem>], [<ore:gearDiamond>, <terrafirmacraft:item.Blue Steel Pick>, <ore:gearDiamond>]]);
...
recipes.addShaped(<BuildCraft|Silicon:laserTableBlock:1>, [[<ore:obsidian>, <BiblioCraft:BiblioWorkbench:*>, <ore:obsidian>], [<ore:obsidian>, <terrafirmacraft:Chest TFC:*>, <ore:obsidian>], [<ore:obsidian>, <BuildCraft|Silicon:redstoneChipset>, <ore:obsidian>]]);
...
recipes.addShaped(<BuildCraft|Robotics:requester>, [[<ore:ingotSteel>, <ore:craftingPiston>, <ore:ingotSteel>], [<ore:gearIron>, <terrafirmacraft:Chest TFC:*>, <ore:gearIron>], [<ore:ingotSteel>, <ore:dustRedstone>, <ore:ingotSteel>]]);
